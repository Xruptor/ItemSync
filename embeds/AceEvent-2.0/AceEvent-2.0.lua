...
local MINOR_VERSION = 90000 + tonumber(("$Revision: 1102 $"):match("(%d+)"))
...
--		WOW 5.x Client has removed both APIs: GetRealNumRaidMembers() and GetRealNumPartyMembers()
		if GetNumGroupMembers(LE_PARTY_CATEGORY_INSTANCE) > 0 or GetNumGroupMembers(LE_PARTY_CATEGORY_HOME) > 0 then SendAddonMessage("LOOT_OPENED", "", "RAID") end
	end)
